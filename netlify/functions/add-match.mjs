...
function storedDateToIso(value) {
  ...
  if (!m) return null;
  return candidateIso(+m[3], +m[2], +m[1]);
}
...
export default async (request) => {
  ...
  try {
    ...
    // DATE() is locale-independent and always produces a real date value.
    // Formatting the new cell DD/MM/YYYY also makes the GViz live feed stable.
